...
<div class="page-content-wrapper">
    <div class="page-content">
                ...
                <div class="col-md-12">
                    ...
                    <form id="formfilter" class="navbar-form navbar-right">
                        <div class="form-group">
                            <select id="selectcabang" name="cabang_id" class="form-control">
                                <option value="">Pilih Cabang</option>
                                <?php foreach ($cabang as $cb): ?>
                                    <option
                                        value="<?= $cb['id'] ?>" <?= isset($cabang_id) ? $cabang_id == $cb['id'] ? 'selected' : '' : '' ?> ><?= $cb['name'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="input-group input-medium date date-picker" data-date=""
                             data-date-format="dd-mm-yyyy">
                            <input value="<?=isset($start_date)?$start_date:''?>" type="text" class="form-control" id="datepicker-start" name="start_date" readonly
                                   data-validation="required"
                                   data-validation-error-msg="<?php echo lang('cal_p_s_d'); ?>">
                                            <span class="input-group-btn">
                                                <button class="btn default" type="button"><i class="fa fa-calendar"></i>
                                                </button>
                                            </span>
                        </div>
                        <div class="input-group input-medium date date-picker-dash">
                            <input value="<?=isset($end_date)?$end_date:''?>" type="text" class="form-control" name="end_date" readonly data-validation="required" data-validation-error-msg="<?php echo lang('cal_p_e_d'); ?>">
                                            <span class="input-group-btn">
                                                <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
                        </div>
                        <button type="button" class="btn btn-default btn-lihat">Lihat</button>
                    </form>
                </div>
            </div>
        <?php endif; ?>
        ...
        if ($this->ion_auth->is_accountant()) { ?>
            <div class="row">
                <div class="col-md-12">
                    <a class="btn blue btn-block fee_button"
                       onClick="javascript:return confirm('Are you sure you want to calculate all students fees for this month.')"
                       href="index.php/home/end_stu_calcu"> Calculate Students Month End Fee </a>
                </div>
            </div>
        <?php }
                                                    ...
                                                    <div class="">
                                                        <div class="col-sm-2 effect left_to_right dbilcss6">
                                                            <div class="backDiv subject">
                                                                ...
                                                                <p class="dbilcss8"><?php echo $row4['start_time']; ?>
                                                                    - <?php echo $row4['end_time']; ?></p>

                                                                <p class="dbilcss8">
                                                                    Rome: <?php echo $row4['room_number']; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php } ?>
        ...
        <div class="row ">
            ...
            <?php }
            if ($this->common->user_access('das_message', $userId)) { ?>
                <div class="col-md-6 col-sm-6">
                                                        ...
                                                        <div class="cont">
                                                            <div class="cont-col1">
                                                                <div class="label label-sm label-success">
                                                                    <?php echo lang('des_from'); ?>
                                                                    : <?php echo $senderName; ?>
                                                                </div>
                                                            </div>
                                                            <div class="cont-col2">
                                                                <div class="desc">
                                                                    <?php echo lang('des_subj'); ?>
            ...
            <?php }
            if ($this->common->user_access('das_employ_attend', $userId)) { ?>

                <div class="col-md-2 col-sm-2 margin-top-20">
                    <div class="col-md-12 teaBox">
                        <div class="teacInfoHead1"><?php echo lang('des_present'); ?>
                            <hr style="margin-top: 10px; margin-bottom: 10px;"><?php echo $presentEmploy; ?></div>
                    </div>
                    <div class="col-md-12 teaBox teaBoxMargin">
                        <div class="teacInfoHead2"><?php echo lang('des_absent'); ?>
                            <hr style="margin-top: 10px; margin-bottom: 10px;"><?php echo $absentEmploy; ?></div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        ...
                                        <?php foreach ($notice as $row) { ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <span
                                                        class="label label-sm label-success dbilcss2"> <?php echo $row['receiver']; ?> </span>
                                                </td>
                                                <td>
                                                    <a href="index.php/notice/noticeDetails?dfgdfg_hid=<?php echo $row['id']; ?>"
                                                       class="btn btn-xs green"> <i class="fa fa-paper-plane-o"></i>
                                                        View Details </a>
                                                </td>
                                            </tr>
                                        <?php } ?>
...
<script>
    jQuery(document).ready(function () {
        ...
        $('.btn-lihat').click(function(){
            ...
            var urldas = $('#urldashboard').val();
            window.location.href = urldas + '?' + data;
        });
