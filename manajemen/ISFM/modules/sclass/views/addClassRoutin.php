    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo lang('clas_add_routine'); ?>
                    <small></small>
                </h3>
                    ...
                    <div class="portlet-body form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-2 routineFildMarginBottom">
                                                <select class="form-control" name="day" data-validation="required"
                                                        data-validation-error-msg="">
                                                    <option value=""><?php echo lang('clas_select_day'); ?></option>
                                                    <?php foreach ($day as $row) { ?>
                                                        <option
                                                            class="<?php echo $row['status']; ?>"><?php echo $row['day_name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="col-md-2 routineFildMarginBottom">
                                                <select class="form-control" name="subject" data-validation="required"
                                                        data-validation-error-msg="">
                                            ...
                                            <div class="col-md-2 routineFildMarginBottom">
                                                <select class="form-control" name="teacher" data-validation="required"
                                                        data-validation-error-msg="">
                                            ...
                                            <div class="col-md-2 routineFildMarginBottom">
                                                <input type="text" class="form-control datetimepicker3"
                                                       placeholder="<?php echo lang('clas_start_time_plas'); ?>"
                                                       name="startTime" data-validation="required"
                                                       data-validation-error-msg="">
                                            </div>
                                            <div class="col-md-2 routineFildMarginBottom">
                                                <input type="text" class="form-control datetimepicker3"
                                                       placeholder="<?php echo lang('clas_end_time_plas'); ?>"
                                                       name="endTime" data-validation="required"
                                                       data-validation-error-msg="">
                                            </div>
                                            <div class="col-md-2 routineFildMarginBottom">
                                                <input type="text" class="form-control"
                                                       placeholder="<?php echo lang('clas_roon_no_plas'); ?>"
                                                       name="roomNumber" data-validation="required"
                                                       data-validation-error-msg="">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-actions fluid marginTopNone">
                            <div class="col-md-offset-3 col-md-9">
                                <button class="btn blue" type="submit" name="submit2"
                                        value="Add Routine Subject"><?php echo lang('clas_add_button'); ?></button>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                foreach ($query as $row4) {
                                                    ...
                                                    <div class="col-sm-2 subject">
                                                        ...
                                                        <p class="pFontSize"><?php echo $row4['start_time']; ?>
