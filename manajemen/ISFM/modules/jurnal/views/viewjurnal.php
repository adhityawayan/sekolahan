                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form class="form-horizontal" method="get"
                                      action="<?= site_url('jurnal/filterJurnal') ?>">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input class="form-control form-control-inline input-medium date-picker"
                                                       size="16" type="text" name="date" value="" data-validation="required" data-validation-error-msg="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <select name="cabang_id" onchange="viewClass(this.value)"
                                                        class="form-control" data-validation="required" data-validation-error-msg="">
