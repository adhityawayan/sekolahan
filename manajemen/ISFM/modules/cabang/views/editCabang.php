                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="radio-list">
                                                ...
                                                <input type="radio" name="nonaktif" id="optionsRadios4" value="1" <?=$cabang['nonaktif']==1?'checked':''?>> Tidak Aktif </label>
                                                <label class="radio-inline">
                                                <input type="radio" name="nonaktif" id="optionsRadios5" value="0" <?=$cabang['nonaktif']==0?'checked':''?> > Aktif </label>
                                        </div>
                                </div>
                            </div>
