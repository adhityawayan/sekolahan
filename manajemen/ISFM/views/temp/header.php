    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
                ...
                <?php if ($this->common->user_access('add_new_class', $userId) || $this->common->user_access('all_class_info', $userId) || $this->common->user_access('class_promotion', $userId) || $this->common->user_access('add_subject', $userId) || $this->common->user_access('all_subject', $userId) || $this->common->user_access('assin_optio_sub', $userId) || $this->common->user_access('add_class_routine', $userId) || $this->common->user_access('all_class_routine', $userId) || $this->common->user_access('own_class_routine', $userId) || $this->common->user_access('add_exam_gread', $userId) || $this->common->user_access('exam_gread', $userId) || $this->common->user_access('add_exam_routin', $userId) || $this->common->user_access('all_exam_routine', $userId) || $this->common->user_access('take_exam_attend', $userId) || $this->common->user_access('exam_attend_preview', $userId) || $this->common->user_access('make_result', $userId) || $this->common->user_access('approve_result', $userId) || $this->common->user_access('view_result', $userId) || $this->common->user_access('all_mark_sheet', $userId) || $this->common->user_access('own_mark_sheet', $userId) || $this->common->user_access('make_suggestion', $userId) || $this->common->user_access('all_suggestion', $userId) || $this->common->user_access('own_suggestion', $userId) || $this->common->user_access('creat_notice', $userId)) { ?>
                    <li class="nav-item <?php echo $academic; ?>">
                        ...
                        <ul class="sub-menu">
                            <?php if ($this->common->user_access('add_new_class', $userId) || $this->common->user_access('all_class_info', $userId) || $this->common->user_access('class_promotion', $userId)) { ?>
                                <li class="nav-item <?php echo $class; ?>">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <?php }
                                        if ($this->common->user_access('all_class_info', $userId)) { ?>
                                        ...
                                        <?php }
                                        if ($this->common->user_access('class_promotion', $userId)) { ?>
                                            <li class="nav-item <?php echo $promotion; ?>">
                                                <a href="index.php/sclass/promotion" class="nav-link ">
                                                    <span
                                                        class="title"><?php echo lang('header_class_promot'); ?></span>
                                                </a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                            ...
                            <?php }
                            if ($this->common->user_access('add_subject', $userId) || $this->common->user_access('all_subject', $userId) || $this->common->user_access('assin_optio_sub', $userId)) { ?>
                                <li class="nav-item <?php echo $subject; ?>">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <?php }
                                        if ($this->common->user_access('all_subject', $userId)) { ?>
                                        ...
                                        <?php }
                                        if ($this->common->user_access('assin_optio_sub', $userId)) { ?>
                            ...
                            <?php }
                            if ($this->common->user_access('add_class_routine', $userId) || $this->common->user_access('all_class_routine', $userId)) { ?>
                                <li class="nav-item <?php echo $Routine; ?>">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <?php }
                                        if ($this->common->user_access('all_class_routine', $userId)) { ?>
                            ...
                            <?php }
                            if ($this->common->user_access('own_class_routine', $userId)) { ?>
                            ...
                            <li class="nav-item <?php echo $exam; ?>">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <?php }
                                    if ($this->common->user_access('exam_gread', $userId)) { ?>
                                    ...
                                    <?php }
                                    if ($this->common->user_access('all_exam_routine', $userId)) { ?>
                                    ...
                                    <?php }
                                    if ($this->common->user_access('take_exam_attend', $userId)) { ?>
                                    ...
                                    <?php }
                                    if ($this->common->user_access('exam_attend_preview', $userId)) { ?>
                                    ...
                                    <?php }
                                    if ($this->common->user_access('make_result', $userId)) { ?>
                                    ...
                                    <?php }
                                    if ($this->common->user_access('approve_result', $userId)) { ?>
                                    ...
                                    <?php }
                                    if ($this->common->user_access('view_result', $userId)) { ?>
                                    ...
                                    <?php }
                                    if ($this->common->user_access('all_mark_sheet', $userId)) { ?>
                                    ...
                                    <?php }
                                    if ($this->common->user_access('own_mark_sheet', $userId)) { ?>
                            ...
                            <!-- <?php }
                            if ($this->common->user_access('make_suggestion', $userId) || $this->common->user_access('all_suggestion', $userId)) { ?>
                                        <li class="nav-item <?php echo $suggestion; ?>">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <?php }
                                if ($this->common->user_access('all_suggestion', $userId)) { ?>
                                    ...
                                    <?php }
                            if ($this->common->user_access('own_suggestion', $userId)) { ?>
                ...
                if ($this->common->user_access('admission', $userId) || $this->common->user_access('all_student_info', $userId) || $this->common->user_access('stu_own_info', $userId) || $this->common->user_access('take_studence_atten', $userId) || $this->common->user_access('attendance_preview', $userId) || $this->common->user_access('make_parents_id', $userId) || $this->common->user_access('all_parents_info', $userId)) { ?>
                    <li class="nav-item <?php echo $student11; ?>">
                        ...
                        <ul class="sub-menu">
                            <?php if ($this->common->user_access('admission', $userId) || $this->common->user_access('all_student_info', $userId) || $this->common->user_access('stu_own_info', $userId)) { ?>
                                <li class="nav-item <?php echo $student; ?>">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <?php }
                                        if ($this->common->user_access('all_student_info', $userId)) { ?>
                                        ...
                                        <?php }
                                        if ($this->common->user_access('stu_own_info', $userId)) { ?>
                                            <li class="<?php echo $studentsInfo; ?>">
                                                <a href="index.php/students/studentsInfo?uisd=<?php echo $userId; ?>">
                                                    <span
                                                        class="title"><?php echo lang('header_own_student_info'); ?></span>
                                                </a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                            ...
                            <?php }
                            if ($this->common->user_access('take_studence_atten', $userId) || $this->common->user_access('attendance_preview', $userId)) { ?>
                                    ...
                                    <ul class="sub-menu">
                                        <?php if ($this->common->user_access('take_studence_atten', $userId)) { ?>
                                            <li class="nav-item <?php echo $studentAtten; ?>">
                                                <a href="index.php/dailyAttendance/selectClassAttendance"
                                                   class="nav-link ">
                                                    <span
                                                        class="title"><?php echo lang('header_daily_attend'); ?></span>
                                                </a>
                                            </li>
                                        <?php }
                                        if ($this->common->user_access('attendance_preview', $userId)) { ?>
                                            <li class="nav-item <?php echo $attendansePreviw; ?>">
                                                <a href="index.php/dailyAttendance/selectAttendancePreview"
                                                   class="nav-link">
                            ...
                            <?php }
                            if ($this->common->user_access('make_parents_id', $userId) || $this->common->user_access('all_parents_info', $userId)) { ?>
                                        ...
                                        <?php if ($this->common->user_access('make_parents_id', $userId)) { ?>
                                            <li class="nav-item <?php echo $makeParents; ?>">
                                                <a href="index.php/users/addParents" class="nav-link ">
                                                    <span
                                                        class="title"><?php echo lang('header_give_pare_acc'); ?></span>
                                                </a>
                                            </li>
                                        <?php }
                                        if ($this->common->user_access('all_parents_info', $userId)) { ?>
                ...
                <?php }
                if ($this->common->user_access('teacher_info', $userId) || $this->common->user_access('add_employee', $userId) || $this->common->user_access('add_teacher', $userId)) { ?>
                    <li class="nav-item <?php echo $teachers; ?>">
                        ...
                        <ul class="sub-menu">
                            ...
                            <?php }
                            if ($this->common->user_access('add_teacher', $userId)) { ?>
                ...
                <?php }
                if ($this->common->user_access('add_employee', $userId) || $this->common->user_access('employee_list', $userId) || $this->common->user_access('employ_attendance', $userId) || $this->common->user_access('empl_atte_view', $userId) || $this->common->user_access('check_leav_appli', $userId)) { ?>
                    <li class="nav-item <?php echo $hrm; ?>">
                        ...
                        <ul class="sub-menu">
                            <?php if ($this->common->user_access('add_employee', $userId) || $this->common->user_access('employee_list', $userId)) { ?>
                                <li class="nav-item <?php echo $employee; ?>">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <?php }
                                        if ($this->common->user_access('employee_list', $userId)) { ?>
                            ...
                            <?php }
                            if ($this->common->user_access('employ_attendance', $userId) || $this->common->user_access('empl_atte_view', $userId)) { ?>
                                        ...
                                        <?php if ($this->common->user_access('employ_attendance', $userId)) { ?>
                                            <li class="nav-item <?php echo $teacherAtten; ?>">
                                                <a href="index.php/dailyAttendance/t_a_s_p" class="nav-link ">
                                                    <span
                                                        class="title"><?php echo lang('header_tak_emplo_atte'); ?></span>
                                                </a>
                                            </li>
                                        <?php }
                                        if ($this->common->user_access('empl_atte_view', $userId)) { ?>
                                            <li class="nav-item <?php echo $empl_att; ?>">
                                                <a href="index.php/dailyAttendance/employe_atten_view"
                                                   class="nav-link ">
                                                    <span
                                                        class="title"><?php echo lang('header_emp_atte_view'); ?></span>
                                                </a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                ...
                <?php }
                if ($this->common->user_access('add_account_title', $userId) || $this->common->user_access('fee_collection', $userId) || $this->common->user_access('all_slips', $userId) || $this->common->user_access('trensection', $userId) || $this->common->user_access('pay_salary', $userId) || $this->common->user_access('own_slip', $userId)) { ?>
                    <li class="nav-item <?php echo $account; ?>">
                        ...
                        <ul class="sub-menu">
                            ...
                            <?php }
                            if ($this->common->user_access('all_slips', $userId)) { ?>
                            ...
                            <?php }
                            if ($this->common->user_access('trensection', $userId)) { ?>
                            ...
                            <?php }
                            if ($this->common->user_access('pay_salary', $userId)) { ?>
                            ...
                            <?php }
                            if ($this->common->user_access('own_slip', $userId)) { ?>
                                <li class="nav-item  ">
                ...
                <?php }
                if ($this->common->user_access('add_category', $userId) || $this->common->user_access('all_category', $userId) || $this->common->user_access('add_books', $userId) || $this->common->user_access('all_books', $userId) || $this->common->user_access('add_library_mem', $userId) || $this->common->user_access('memb_list', $userId) || $this->common->user_access('', $userId)) { ?>
                    <!--li class="nav-item <?php echo $library; ?>">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <?php }
                    if ($this->common->user_access('all_category', $userId)) { ?>
                                    ...
                                    <?php }
                    if ($this->common->user_access('add_books', $userId)) { ?>
                                    ...
                                    <?php }
                    if ($this->common->user_access('all_books', $userId)) { ?>
                                    ...
                                    <?php }
                    if ($this->common->user_access('add_library_mem', $userId)) { ?>
                                    ...
                                    <?php }
                    if ($this->common->user_access('memb_list', $userId)) { ?>
                                    ...
                                    <?php }
                    if ($this->common->user_access('issu_return', $userId)) { ?>
                ...
                <?php }
                if ($this->common->user_access('add_dormitories', $userId) || $this->common->user_access('add_set_dormi', $userId) || $this->common->user_access('set_member_bed', $userId) || $this->common->user_access('dormi_report', $userId)) { ?>
                    <!--<li class="nav-item <?php echo $dormitory; ?>">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <?php }
                    if ($this->common->user_access('add_set_dormi', $userId)) { ?>
                                    ...
                                    <?php }
                    if ($this->common->user_access('set_member_bed', $userId)) { ?>
                                    ...
                                    <?php }
                    if ($this->common->user_access('dormi_report', $userId)) { ?>
                ...
                <?php }
                if ($this->common->user_access('add_transport', $userId) || $this->common->user_access('all_transport', $userId)) { ?>
                    <!-- <li class="nav-item <?php echo $transport; ?>">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <?php }
                    if ($this->common->user_access('all_transport', $userId)) { ?>
                ...
                <li class="nav-item <?php echo $cabang; ?>">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        ...
                        <span class="title"><?php echo lang('header_cabang'); ?></span>
                        <span class="arrow "></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item <?php echo $allCabang; ?>">
                            <a href="index.php/cabang/allCabang"
                               class="nav-link"><?php echo lang('header_all_cabang'); ?></a>
                        </li>
                        <li class="nav-item <?php echo $addCabang; ?>">
                            <a href="index.php/cabang/addCabang"
                               class="nav-link"><?php echo lang('header_add_cabang'); ?></a>
                        </li>
                    </ul>
                </li>
                <?php } ?>
                    ...
                    <ul class="sub-menu">
                        <?php if ($this->common->user_access('send_message', $userId)) { ?>
                            <li class="nav-item <?php echo $sendMessage; ?>">
                                <a href="index.php/message/sendMessage"
                                   class="nav-link"><?php echo lang('header_sent_message'); ?></a>
                            </li>
                        <?php } ?>
                ...
                <?php if ($this->common->user_access('vendor', $userId) || $this->common->user_access('add_inv_cat', $userId) || $this->common->user_access('inve_item', $userId) || $this->common->user_access('inve_issu', $userId)) { ?>
                    <!--li class="nav-item <?php echo $stock; ?>">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <?php }
                    if ($this->common->user_access('add_inv_cat', $userId)) { ?>
                ...
                <?php if ($this->common->user_access('setting_manage_user', $userId) || $this->common->user_access('setting_accounts', $userId) || $this->common->user_access('other_setting', $userId)) { ?>
                    <li class="nav-item <?php echo $configuration; ?>">
                        ...
                        <ul class="sub-menu">
                            ...
                            <?php }
                            if ($this->common->user_access('setting_accounts', $userId)) { ?>
                            ...
                            <?php }
                            if ($this->common->user_access('other_setting', $userId)) { ?>
